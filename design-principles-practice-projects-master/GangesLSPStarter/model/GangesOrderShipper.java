...
public class GangesOrderShipper {
    ...
    public static void main(String[] args) {
        ...
        StandardSizedBook b2 = new OversizedStandardSizedBook("The Princess Brideshead Revisited", 29.15);

        // Add them to a list so it's easy to iterate through them
        List<StandardSizedBook> booksToShip = new ArrayList<>();
        booksToShip.add(b1);
        booksToShip.add(b2);

        for (StandardSizedBook b : booksToShip) {
